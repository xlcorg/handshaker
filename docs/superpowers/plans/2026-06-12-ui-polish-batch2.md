...
- [x] **Step 1: Обновить тест Titlebar (упадёт после правки — фиксируем намерение)**
...
- [x] **Step 6: main.tsx — безусловный dark**
...
- [x] **Step 7: monaco.ts — только тёмная тема**
...
- [x] **Step 10: Прогнать тесты и tsc**
...
- [x] **Step 3: Реализовать `zoom.ts` (пока без хука)**
...
- [x] **Step 1: Написать падающий тест хука**
...
- [x] **Step 3: Реализовать хук в `zoom.ts`**
...
- [x] **Step 5: Подключить в WorkflowApp**
...
- [x] **Step 4: Тест зелёный + полный прогон**
...
- [x] **Step 1: Написать падающий регрессионный тест**
...
- [x] **Step 2: Убедиться, что тест падает (воспроизводит баг)**
...
- [x] **Step 3: Реализовать фикс в BodyView**
...
- [x] **Step 1: Падающий тест чистой функции**
...
- [x] **Step 4: Падающий тест openSavedRequest-сидинга**
...
- [x] **Step 5: Реализовать сидинг в openSavedRequest**
...
- [x] **Step 6: Падающий тест applyMethodSelection**
...
- [x] **Step 7: Реализовать в applyMethodSelection + CallPanel**
...
- [x] **Step 1: Падающий тест планировщика**
...
- [x] **Step 3: Реализовать планировщик**
...
- [x] **Step 4: Падающий тест кнопки «+» в MethodPicker**
...
- [x] **Step 5: Реализовать кнопку в MethodPicker**
...
- [x] **Step 6: Исполнитель в WorkflowApp + проброс**
...
- [x] **Step 1: Падающий тест возврата duplicateItem**
...
- [x] **Step 3: Падающий тест кнопки в FocusView**
...
- [x] **Step 4: Реализовать кнопку в FocusView**
...
- [x] **Step 1: Полный фронтовый гейт**
