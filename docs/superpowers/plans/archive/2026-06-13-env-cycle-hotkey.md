...
**Статус:** 🎉 DONE (2026-06-13; влита в `main` ff `d6f36b3`; commits `b238377`…`d6f36b3`). Гейт: vitest **880** · tsc clean · бэкенд/bindings не тронуты. Live-verified в WebView2 (в т.ч. русская раскладка). Live-фидбек: keycap-хинт перенесён из шапки в некликабельный футер дропдауна («Cycle environment · Ctrl+E/⌘E»). План+спека в `archive/`.
