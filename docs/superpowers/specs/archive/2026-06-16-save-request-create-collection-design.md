...
**Статус:** 🎉 DONE 2026-06-16 · реализовано, влито в `main` ff (`d473744`+`6bd0545`). План: [`2026-06-16-save-request-create-collection.md`](../../plans/archive/2026-06-16-save-request-create-collection.md)
