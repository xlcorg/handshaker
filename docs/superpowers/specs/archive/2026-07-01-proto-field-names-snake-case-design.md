...
**Статус:** 🎉 DONE 2026-07-01 (ff в `main` `ce0bf00`; план+спека перемещены в `archive/`).
Гейт: `cargo test --workspace` 319 · vitest 1214 · `tsc -b` · `vite build` · bindings no-drift.
Живой WebView2-проход ещё НЕ пройден.
